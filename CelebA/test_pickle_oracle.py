...
with open('10_percent.pkl', 'wb') as f:
...
with open('25_percent.pkl', 'wb') as f:
    pickle.dump(curr_req, f)
...
with open('40_percent.pkl', 'wb') as f:
    pickle.dump(curr_req, f)
...
with open('50_percent.pkl', 'wb') as f:
    pickle.dump(curr_req, f)
...
with open('75_percent.pkl', 'wb') as f:
    pickle.dump(curr_req, f)
...
with open('90_percent.pkl', 'wb') as f:
    pickle.dump(curr_req, f)
...
with open('95_percent.pkl', 'wb') as f:
    pickle.dump(curr_req, f)
...
with open('97_percent.pkl', 'wb') as f:
    pickle.dump(curr_req, f)
...
with open('99_percent.pkl', 'wb') as f:
    pickle.dump(curr_req, f)
