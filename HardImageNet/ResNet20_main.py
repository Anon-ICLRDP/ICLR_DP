...
if training_required:
  ...
  unpruned_net = torchvision.models.resnet18(pretrained=False)
  d = unpruned_net.fc.in_features
  unpruned_net.fc = torch.nn.Linear(d, 15)
  torch.save(unpruned_net, 'Untrained.pt')
  unpruned_net.cuda()
  #unpruned_net = nn.DataParallel(unpruned_net.cuda())
  optimizer = optim.SGD(unpruned_net.parameters(), lr=0.01, momentum=0.9, weight_decay=1e-4)
...
torch.save(unpruned_net, 'ResNet20_last.pt')
