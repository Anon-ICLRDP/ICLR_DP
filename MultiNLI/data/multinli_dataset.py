...
'''with open('multinli/data/drop_indices.pkl', 'rb') as f:
...
class MultiNLIDataset(ConfounderDataset):
    ...
    def __init__(self, root_dir,
        ...
        #self.features_array = [self.features_array[i] for i in range(len(self.features_array)) if i not in drop_indices]
